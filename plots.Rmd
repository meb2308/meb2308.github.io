...
instacart = 
  instacart %>% 
  select(order_id, order_dow, order_hour_of_day, reordered, product_id, product_name, department) %>% 
  mutate(
    order_dow = recode(order_dow, "0" = "Sunday", "1" = "Monday", "2" = "Tuesday", "3" = "Thursday", "4" = "Friday", "6" = "Saturday")
  ) %>% 
  sample_n(10000)
```
...
This plot shows the number of products ordered by department. 
